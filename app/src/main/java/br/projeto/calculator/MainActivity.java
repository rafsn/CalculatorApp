...
public class MainActivity extends AppCompatActivity {
    ...
    private MaterialButton button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonDot, buttonAdd, buttonMultiply, buttonDivide, buttonPercent, buttonClear, buttonOFF, buttonEqual, buttonSub;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                outputDisplay.setText(inputDisplay.getText() + ".");
            }
        });
